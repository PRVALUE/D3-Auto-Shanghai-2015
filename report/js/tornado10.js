...
svg.append("image")
    ...
    .attr("width",14.5)  
    .attr("height",14.5)  
    .attr("xlink:href","../img/p27-10.png"); 
...
function render(data, category) {
        ...
        d3.select("#canvas-svg10").selectAll("div.p24-2chart") // <-D
                .data(data)
            .attr("class", "p24-2chart")
