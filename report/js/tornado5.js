...
svg.append("image")
    ...
    .attr("width",14.5)  
    .attr("height",14.5)  
    .attr("xlink:href","http://autoshanghai2015-cdn.prvalue.cn/img/p23-7.png"); 
...
svg.append("image")
    ...
    .attr("width",14.5)  
    .attr("height",14.5)  
    .attr("xlink:href","http://autoshanghai2015-cdn.prvalue.cn/img/p23-11.png"); 
...
svg.append("image")
    ...
    .attr("width",14.5)  
    .attr("height",14.5)  
    .attr("xlink:href","http://autoshanghai2015-cdn.prvalue.cn/img/p23-12.png"); 
...
function render(data, category) {
        ...
        var greed_barchart = d3.select("#canvas-svg5").selectAll("div.p23-chart") // <-D
                .data(data)
            .attr("class", "p23-chart")
