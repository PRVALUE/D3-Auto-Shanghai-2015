...
svg.append("image")
    ...
    .attr("width",14.5)  
    .attr("height",14.5)  
    .attr("xlink:href","../img/p26-10.png"); 
...
function render(data, category) {
        ...
        d3.select("#canvas-svg8").selectAll("div.p23-chart") // <-D
                .data(data)
            .attr("class", "p23-chart")
            .style("width", function (d) {
                return (d.expense * 5 +50) + "px";}
            );
