$(function(){
  $("#doughnutChart").drawDoughnutChart([
    { title: "新浪汽车",         value : 120,  color: "#2C3E50" },
    { title: "网易汽车", value:  80,   color: "#FC4349" },
    { title: "腾讯汽车",      value:  70,   color: "#6DBCDB" },
    { title: "易车网",        value : 50,   color: "#F7E248" },
    { title: "MSN汽车",        value : 40,   color: "#D7DADB" },
    { title: "太平洋汽车",        value : 20,   color: "#FFF" }
  ]);
});
/*!
